(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        function init() {
            var mapOptions = {
                zoom: 17,
                center: new google.maps.LatLng(3.849594, 11.501372),
        ...
        $('form#contact-form').on('submit', function (e) {
            ...
            $.ajax({
                ...
                .done(function () {
                    ...
                    Materialize.toast('Message envoyé! Je vous contacterai bientôt, Merci', 4000);
                ...
                .fail(function () {
                    $('div#form-loader').fadeOut(500);
                    Materialize.toast('Pardon! Quel que chose ne va pas, essayez de nouveau', 4000);
                    $("#submit").removeAttr('disabled', 'disabled'); // Enable submit button
                });
        });
